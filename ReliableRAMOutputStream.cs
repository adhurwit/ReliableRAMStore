...
namespace Lucene.Net.Store
{
	...
	/// </summary>
	public class ReliableRAMOutputStream:IndexOutput
	{
		internal const int BUFFER_SIZE = 1024;
		
		private ReliableRAMFile file;
		...
		public ReliableRAMOutputStream():this(new ReliableRAMFile())
		{
		}

        internal ReliableRAMOutputStream(ReliableRAMFile f)
		{
			file = f;
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            ReliableRAMDirectory.UpdateFile(file);
