...
namespace Lucene.Net.Store
{
	...
	/// 
	/// </summary>
	public class ReliableRAMInputStream : IndexInput
	{
		...
		public /*internal*/ ReliableRAMInputStream(ReliableRAMFile f)
		{
			file = f;
			length = file.length;
        ...
        static ReliableRAMInputStream()
		{
            BUFFER_SIZE = ReliableRAMOutputStream.BUFFER_SIZE;
		}
	}
}