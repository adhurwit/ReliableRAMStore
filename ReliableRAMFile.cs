...
namespace Lucene.Net.Store
{
	...
	public class ReliableRAMFile
	{
		...
		internal ReliableRAMDirectory directory;
		...
		public /*internal*/ ReliableRAMFile()
		{
		}

        public /*internal*/ ReliableRAMFile(ReliableRAMDirectory directory, string name)
		{
            MapName = name;
